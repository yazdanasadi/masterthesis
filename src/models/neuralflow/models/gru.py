...
from src.models.neuralflow.models import ODEModel
...
class GRUODENet(Module):
    ...
    def forward(self, t: Tensor, inp: Tuple[Tensor, Tensor]) -> Tuple[Tensor, Tensor]:
...
class ContinuousGRULayer(Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if model == "ode":
            self.odeint = ODEModel(
                hidden_dim, GRUODENet(hidden_dim), None, None, None, solver, solver_step
            )
