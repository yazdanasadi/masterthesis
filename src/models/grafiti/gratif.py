...
import  src.models.grafiti.gratif_layers as gratif_layers
...
def tsdm_collate_sparse(batch: list[Sample]) -> Batch:
    x_time,x_vals,x_mask,y_time,y_vals,y_mask = tsdm_collate(batch)
