...
from src.models.linodenet.projections import functional, modular
from src.models.linodenet.projections.functional import (
    banded,
    diagonal,
    identity,
    masked,
...
from src.models.linodenet.projections.modular import (
    Banded,
    Diagonal,
    Identity,
    Masked,
