...
from src.models.linodenet.regularizations import functional, modular
from src.models.linodenet.regularizations.functional import (
    banded,
    diagonal,
    identity,
    logdetexp,
...
from src.models.linodenet.regularizations.modular import (
    Banded,
    Diagonal,
    Identity,
    LogDetExp,
