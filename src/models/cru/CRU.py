...
from src.models.cru.CRUCell import var_activation, var_activation_inverse
from src.models.cru.CRULayer import CRULayer
from src.models.cru.data_utils import (
    adjust_obs_for_extrapolation,
    align_output_and_target,
)
from src.models.cru.decoder import BernoulliDecoder, SplitDiagGaussianDecoder
from src.models.cru.encoder import Encoder
from src.models.cru.losses import GaussianNegLogLik, bernoulli_nll, mse, rmse
from src.models.cru.utils import TimeDistributed, log_to_tensorboard, make_dir
    ...
    def train(self, train_dl, valid_dl, test_dl, identifier, logger, epoch_start=0):
        ...
        for epoch in range(epoch_start, self.args.epochs):
            ...
            if valid_mse < best_valid:
                ...
                es += 1
            if es == 15:
                print("early stopping because valid loss did not improve for 30 epochs")
                break
